    ...
    <div className="z-3 flex h-full max-h-screen min-h-screen w-full flex-1 flex-col items-center overflow-x-hidden bg-color">
      ...
      <div className="flex w-full flex-grow flex-col flex-wrap justify-center px-4 md:flex-row md:gap-10 md:px-6 max-w-[75rem] xl:max-w-[90rem]">
        <div className="z-1 flex w-full max-w-[26.25rem] flex-col overflow-y-auto rounded-16 w-full rounded-none md:max-w-[30rem] h-full">
          ...
          <p className="mt-3 whitespace-pre-line px-6 text-center text-gray-300">
            Once you sign up and provide necessary requirements, you'll be ready
            to explore the application infinitly.
          </p>
            ...
            >
              ...
              <div className="flex flex-col items-stretch">
                <div className="relative flex rounded-xl flex-row items-center pl-3 h-12 px-4 overflow-hidden bg-gray-900 hover:bg-gray-800 border border-transparent cursor-text border-l-4 border-l-purple-500">
                  ...
                  <SquareArrowRight01Icon className="mr-2 text-gray-400 hover:text-white" />
                  {/* Error alert */}
                </div>
              ...
              <span className="mt-4 flex w-full flex-row flex-wrap-reverse">
                <Button
                  className="flex flex-1 disabled:bg-transparent disabled:cursor-not-allowed hover:bg-transparent text-gray-400 underline"
                  disabled
                >
                ...
                >
                  {isPending ? (
                    <ImSpinner9 className="animate-spin text-lg text-purple-600" />
                  ) : (
                    "Sign up"
                  )}
                </Button>
          ...
          <div className="flex h-full max-h-[10rem] w-full px-4 md:px-6 max-w-[75rem] xl:max-w-[90rem]">
            <div className="relative flex flex-1 flex-col gap-6 pb-6 md:mt-auto lg:mr-8 lg:max-w-[27.5rem]"></div>
            <p className="w-full text-center text-gray-400 text-xs mt-0 hidden md:mt-10 md:block">
